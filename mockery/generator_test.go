...
import test "github.com/DispatchMe/mockery/mockery/fixtures"
...
import fixtureshttp "github.com/DispatchMe/mockery/mockery/fixtures/http"
import http "net/http"
import mock "github.com/stretchr/testify/mock"
import test "github.com/DispatchMe/mockery/mockery/fixtures"
...
func (s *GeneratorSuite) TestGeneratorWithImportSameAsLocalPackageInpkgNoCycle() {
	...
	gen.GeneratePrologue(pkg)
	s.NotContains(gen.buf.String(), `import test "github.com/DispatchMe/mockery/mockery/fixtures/test"`)
}
...
import mock "github.com/stretchr/testify/mock"
import test "github.com/DispatchMe/mockery/mockery/fixtures/test"
